...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ImgShow.setGeometry(QtCore.QRect(10, 10, 281, 151))
        ...
        self.REC.setGeometry(QtCore.QRect(10, 160, 281, 301))
...
"font: 9pt \"Microsoft YaHei UI\";")
        ...
        self.Batchbox = QtWidgets.QGroupBox(self.centralwidget)
        self.Batchbox.setGeometry(QtCore.QRect(310, 20, 491, 441))
        self.Batchbox.setStyleSheet("background-color: rgb(0, 255, 255);")
        self.Batchbox.setObjectName("Batchbox")
        self.dirpath = QtWidgets.QLabel(self.Batchbox)
        self.dirpath.setGeometry(QtCore.QRect(10, 30, 471, 41))
        self.dirpath.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.diropen = QtWidgets.QAction(MainWindow)
        self.diropen.setObjectName("diropen")
        self.menu.addAction(self.fileopen)
        self.menu.addAction(self.diropen)
